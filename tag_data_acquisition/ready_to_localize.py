...
if __name__ == "__main__":
    ...
    anchors = [DeviceCoordinates(0x100A, 1, Coordinates(    0,    0, 1330)),
               DeviceCoordinates(0x100B, 1, Coordinates(-1780, 4480, 2230)),
               DeviceCoordinates(0x100C, 1, Coordinates( 1700, 5170, 1840))]#,
